...
const StickFigureBody = styled.div`
  ...
  &::after {
    ...
    position: absolute;
    background-color: ${({ color }) => color};
    width: calc(${({ size }) => size * 0.15 * 0.5}px);
    height: calc(${({ size }) => size * 0.35 * 0.95}px);
    top: 1%;
  }

  &::before {
    left: calc(${({ size }) => -(size * 0.15 * 0.5 * 0.5)}px);
  ...
  &::after {
    right: calc(${({ size }) => -(size * 0.15 * 0.5 * 0.5)}px);
    transform: rotate(-10deg);
    border-top-right-radius: calc(${({ size }) => size} * 0.02px);
...
const StickFigureRightArm = styled.div`
  position: absolute;
  background-color: ${({ color }) => color};
  right: calc(${({ size }) => size - (size + size * 0.1)}px);
  width: 30%;
  height: calc(${({ size }) => size * 0.35}px);
  border-radius: calc(${({ size }) => size} * 0.02px);
  transform: rotate(-10deg);
